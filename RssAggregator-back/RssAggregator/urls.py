"""
URL configuration for RssAggregator project.
...
from Articles.views import ArticleViewSet , RSSFeedViewSet
from Interactions.views import InteractionsViewset , HistoryViewset
from drf_spectacular.views import SpectacularSwaggerView, SpectacularAPIView
from rest_framework_nested import routers
router = routers.DefaultRouter()
router.register(r'articles', ArticleViewSet, basename="article")
router.register(r'feeds', RSSFeedViewSet, basename='newspaper')
